<?php
   ...
   {
      $sql = "SELECT * from complainant " . $queryCondition . " ORDER BY crime ASC";
...
<html>
   ...
   <body>
    <div class="demo-content">
      <h2 class="title_with_link">Complainants report filter based on crime </h2>
  <form name="frmSearch" method="post" action="">
    <p class="search_input">
<label for="">crime:</label>
<select name=crime class="form-control" placeholder="crime">
            <?php
