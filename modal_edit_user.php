...
$userid=$row['username'];
  ...
  $query2=mysqli_query($conn,"SELECT * FROM userlogin where username='$userid'");
            ...
            <div class="form-row" style="">
              <div class="col-md-7">
                <div class="form-group">
                  ...
                  <input type="text" readonly="" name="username" value="<?php echo $row1['username']?>" class="form-control" id="staffid" >
                </div>
              </div>
               </div>
