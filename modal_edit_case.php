...
echo $row['case_id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form action="edy.php" method="post">
     
    <?php
include 'dbconnect.php';
$case_id=$row['case_id'];
  
  $query2=mysqli_query($conn,"SELECT * FROM case_table where case_id='$case_id'");
