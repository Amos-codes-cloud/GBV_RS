...
<div class="container-fluid">
	...
	<div class="col-md-8">
		...
		<a href="investigation.php<?php echo '?edit='.$case_id; ?>"  class="btn btn-info" style="margin-bottom:20px"><i class="icon-print icon-large"></i> Investigation Statement</a>

		<a href="assigncase.php<?php echo '?case_id='.$case_id; ?>"  class="btn btn-info" style="margin-bottom:20px"><i class="icon-print icon-large"></i> <?php if($status=='' or $status=='Not Yet' ){echo 'Assign This Case to CID Officer';} else{echo 'Change CID Officer';}?></a>
		</script>
			...
			<div class="panel-body">
			 ...
			 <div class="panel panel-success">
			 	...
			 	<div class="panel-body">
			 		<?php
			 		include 'dbconnect.php';
			 		$query=mysqli_query($conn,"select * from complaints where case_id='$case_id'");
		while($row = mysqli_fetch_array($query)){
			?>
			 			 <table class="table">
			 			 	...
			 			 	<tr>
			 			 		<td>Name:</td><td><?php echo $row['Firstname']?></td>
			 			 	</tr>
			 			 	<tr>
			 	...
			 	<div class="panel-body">
			 		<table id="myTable-party" class="table table-bordered table-hover" cellspacing="0" width="100%">
						    ...
						    <tbody>
						    	<?php
						    	$sn=0;
			 		$query=mysqli_query($conn,"select * from case_table where case_id='$case_id'");
		while($row = mysqli_fetch_array($query)){
			$sn++;
			?>
...
<script type="text/javascript">
    ...
    function window_print(){
		...
		_html.append("<h3 class='text-center'>ONLINE CRIME REPORTINGSYSTEM</h3>")
		_html.append(_p)
