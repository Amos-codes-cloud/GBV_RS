...
<body>
   ...
   include'dbconnect.php';
    ...
    $query = "SELECT * FROM case_table WHERE case_id='$case_id' ";
            ...
            <div class="container">
                <div class="jumbotron">
                    ...
                    if(isset($_POST['update']))
                    {
                        ...
                        $query = "UPDATE case_table SET status='$status', diaryofaction='$statement', complete_date=' $date' WHERE case_id='$case_id'  ";
                        $query_run = mysqli_query($conn, $query);
