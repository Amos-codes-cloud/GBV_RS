...
<a href="#" onClick="window_print()" class="btn btn-info" style="margin-bottom:20px"><i class="icon-print icon-large"></i> Print</a>
			...
			<div class="panel-body">
			 ...
			 <div class="container-fluid">
					<form class="form-horizontal" action="savecidstatement.php" method="post" role="form">
					  ...
					  <?php
					  include 'dbconnect.php';
			 		$query=mysqli_query($conn,"select * from complainant where case_id='$caseid'");
		while($row = mysqli_fetch_array($query)){
			?>
			 			 ...
			 			 $query2=mysqli_query($conn,"select * from case_table where case_id='$caseid'");
...
<script type="text/javascript">
    ...
    function window_print(){
		...
		_html.append("<h3 class='text-center'>ONLINE CRIME REPORTING SYSTEM</h3>")
		_html.append(_p)
