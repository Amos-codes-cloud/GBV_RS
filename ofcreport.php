<?php
	...
	if(!empty($_POST["search"]["post_at"])) {			
		...
		$queryCondition .= "WHERE date_added BETWEEN '$fiy-$fim-$fid' AND '" . $post_at_todate . "'";
	}

	$sql = "SELECT * from complainant " . $queryCondition . " ORDER BY date_added desc";
	$result = mysqli_query($conn,$sql);
?>

<html>
	<head>
    <title>Report filter based on date</title>		
    ...
    <div class="demo-content">
		<h2 class="title_with_link">Report filter based on dates</h2>
